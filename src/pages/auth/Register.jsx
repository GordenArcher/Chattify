...
export const Register = () => {
  ...
  const registerUser = async (e) => {
    ...
    const fetchApiUrl = `${BASE_URL}/auth/register/`;
                    ...
                    <form className="form">
                        <div className="flex-column">
                          ...
                          <div className="inputForm">
                              ...
                              <input type="text" name='username' className="input" value={registerData.username} required placeholder="Enter your Username" onChange={(e) => setRegisterData((prevData) => ({...prevData, username:e.target.value}))} />
                          </div>
                          ...
                          <div className="inputForm">
                            <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="currentColor" className="bi bi-envelope env" viewBox="0 0 16 16">
                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                              </svg>
                              <input type="email" name='email' className="input" value={registerData.email} required placeholder="Enter your Password" onChange={(e) => setRegisterData((prevData) => ({...prevData, email:e.target.value}))} />
                          ...
                          <div className="inputForm">
                              ...
                              <input type="password" name='password' className="input" value={registerData.password} required placeholder="Enter your Password" onChange={(e) => setRegisterData((prevData) => ({...prevData, password:e.target.value}))} />
                          ...
                          <div className="inputForm">
                              <svg height={20} viewBox="-64 0 512 512" width={20} xmlns="http://www.w3.org/2000/svg"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0" /><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0" /></svg>        
                              <input type="password" name='password2' className="input" value={registerData.password2} required placeholder="Enter your Password" onChange={(e) => setRegisterData((prevData) => ({...prevData, password2:e.target.value}))} />
                          </div>
                            
                          <button className="button-submit" onClick={registerUser}>{ loader? <Loader /> : "Register"}</button>
                          <p className="p">Have an account? <span className="span"><Link to={'/auth/login'}>Log In</Link> </span>
                            </p><p className="p line">Or With</p>
                            <div className="flex-row">
                                    <GoogleLogin  client_id={client_id} className="btn google" onSuccess={handleLogin} onError={(error) => console.log(error)}>
